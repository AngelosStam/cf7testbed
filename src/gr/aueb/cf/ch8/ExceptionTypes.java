...
public class ExceptionTypes {
     ...
     * Is this meaningful?
     * No. Ideally we would like to handle exceptions, not only propagate.
     *
     * @return
     * @throws IOException
     */
     ...
     * If there is a client / user we dot propagate the exception.
     *
     * @return
     */
     ...
     * --logging and also rethrow the exception to propagate to the caller.
     *
     * @return
     * @throws IOException
     */
