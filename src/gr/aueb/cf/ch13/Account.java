...
public class Account {
    ...
    /**
     * Withdraws a certain amount of money from the {@link Account}
     * based on a valid ssn checked by {@link #isSsnValid(String)}.
     *
     * @param amount        the amount of money to be withdrawn.
     * @param ssn           the given ssn
     * @throws Exception    if the ssn is not valid or the balance is insufficient or the amount is negative.
     */
    ...
    public double getAccountBalance() {
        System.err.println("The account balance was returned"); //logging
        return getBalance();
    }
