 ...
 * 'Άριστα' αν ο μ. ό. είναι >=9, 'Πολύ καλά' αν
 * ο μ.ό. είναι >=7, 'Καλώς' αν ο μ.ό. είναι >= 5
 * και 'Αποτυχία' αν ο μ.ό. είναι < 5.
 *
 */
public class GradesApp {
    ...
    public static void main(String[] args) {
        ...
        if (average > 10) {
            System.out.println("Error. The average must less or equal than 10.");
            System.exit(1);
        }
